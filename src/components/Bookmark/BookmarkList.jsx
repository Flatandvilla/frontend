  ...
  const handleDeleteBookmark = async (userId, bookmarkId) => {
    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/bookmarks/delete/${userId}/${bookmarkId}/`, {
        ...
        toast.success(`Bookmark "${bookmarkToDelete.name}" deleted successfully!`);
    } catch (error) {
...
<div className="flex justify-between mb-2">
  <div className="relative flex-grow">
    ...
    <button
      ...
      right-0 flex items-center justify-center px-3 text-white bg-blue rounded-r-md cursor-pointer hover:bg-blue-dark" // Adjusted classes for positioning
