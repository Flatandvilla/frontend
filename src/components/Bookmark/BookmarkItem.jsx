...
import { FaFolder, FaChevronDown, FaFolderOpen, FaTrash, FaEdit,FaSave  } from 'react-icons/fa'; // Import necessary icons
...
items-center p-2 text-black bg-white hover:bg-blue-100 rounded-md cursor-pointer">
  ...
  <div className='flex items-center'>
    ...
    {isEditMode ? (
      ...
      <FaEdit className="ml-2 cursor-pointer text-green-700"
