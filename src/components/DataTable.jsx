...
const renderProgressBars = () => {
  return Object.entries(updateProgress).map(([queryId, { progress }]) => (
    <div key={queryId} className="progress-container" style={{ margin: '10px 0' }}>
      <div style={{ marginBottom: '5px' }}>Updating  {progress.toFixed(2)}%</div>
      <div className="progress-bar" style={{ width: '100%', backgroundColor: '#eee' }}>
        <div
          className="progress"
          style={{
            width: `${progress}%`,
...
{/* <div 
    ...
    style={{ bottom: showUpdates ? '0' : '-176px' }}
  >
    <div 
