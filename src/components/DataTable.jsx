...
//     const updateUrl = `http://192.168.0.175:8003/api/update-rank/${userId}/${query}/${targetUrl}/${google_domain}/`;
...
//       const apiUrl = `http://192.168.0.175:8003/api/favourites/${userId}/${encodeURIComponent(query)}/${target_url}/${google_domain}/${b_id}/`;
...
// <div className="px-10 py-[70px] dark:bg-slate dark:text-blue" >
...
//         <label className="block font-semibold mt-3 mb-1 dark:text-blue ">Search for keyword</label>
...
//       <div className="p-4 w-full md:w-1/3 px-2">
//         <label className="block font-semibold mt-3 mb-1 dark:text-blue">Filter by Target URL</label>
...
//       <div className="p-4 w-full md:w-1/3 px-2">
//       <label className="block font-semibold mt-3 mb-[-8px] dark:text-blue">Filter by Location</label>
...
// {/* <form onSubmit={handleSubmit(onBulkSubmit)}> 
// {tabsData.map(tab => tab.formFields.map(field => {
//   switch (field.type) {
//     case "input":
//       return (
//         <input
