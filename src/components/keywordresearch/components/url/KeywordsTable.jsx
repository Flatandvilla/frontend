...
import DataTable from 'react-data-table-component';
  ...
  const KeywordsTable = ({ data, onKeywordClick }) => {
  ...
  const columns = [
      ...
      },
    {
      ...
      sortable: true,
      minWidth: '15%',
      cell: (row) => <div  className=' text-center mx-auto'>{row.count}</div>, 
    ...
    },
    {
      ...
      sortable: true,
      minWidth: '15%', 
      cell: (row) => <div  className=' text-center mx-auto'>{row.avg} % </div>, 
      sortIcon: <div style={{ display: 'inline' }}>▲▼</div>, // Custom sort icon
